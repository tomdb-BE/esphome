...
void ESP32RMTLEDStripLightOutput::setup() {
  ...
  ExternalRAMAllocator<rmt_symbol_word_t> rmt_allocator(ExternalRAMAllocator<rmt_symbol_word_t>::ALLOW_FAILURE);
  this->rmt_buf_ = rmt_allocator.allocate(buffer_size * 8);  // 8 bits per byte, 1 rmt_symbol_word_t per bit
